...
{
    ui->setupUi(this);//4 математических операции
...
num_first=(ui->lineEdit_gradus->text().toInt())*3600+(ui->lineEdit_minute->text().toInt())*60+ui->lineEdit_second->text().toInt();//перевод данных 1 числа в секунды
...
void MainWindow::on_clear_clicked()//очистка окон вввода,вывода
{
...
void MainWindow::on_result_clicked()//функция математичекских действий и выведения результата
{
...
else if(ui->minus->isChecked())//вычитание
{
...
else if(ui->mult->isChecked())// умножение на число
{
...
else if(ui->delenie->isChecked())// деление на число
{
    if(int_number==0)// защита от деления на 0
    {
